...
namespace ControlR.Web.Server.Data.Migrations
{
    ...
    [Migration("20260307120000_AddPatExpiryAndRevocation")]
    partial class AddPatExpiryAndRevocation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.AlertRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<List<Guid>>("TargetDeviceIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");

                    b.PrimitiveCollection<List<Guid>>("TargetGroupIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("dbc6d9b9-98c0-7ac9-e446-f612efd8eafd"),
                            ConcurrencyStamp = "e4f8c2a1-7b3d-4e6f-9a1c-5d2b8e4f7a3c",
                            Name = "Client User",
                            NormalizedName = "CLIENT USER"
                        });
                });
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.AutomationSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("SuggestedScriptId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SuggestedScriptId");

                    b.HasIndex("TenantId");

                    b.ToTable("AutomationSuggestions");
                });

            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.BrandingSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ClientDeviceAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ClientUserId", "DeviceId")
                        .IsUnique();

                    b.ToTable("ClientDeviceAssignments");
                });
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.Device", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastInventoryScan")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.DeviceMetricSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("DeviceMetricSnapshots");
                });

            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.InstalledUpdate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DeviceId", "UpdateId");

                    b.ToTable("InstalledUpdates");
                });

            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.JitAdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("JitAdminAccounts");
                });

            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.PatchInstallation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("PatchInstallations");
                });

            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.PendingPatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.PluginRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("PluginTypeName")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.SavedScript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("IsPublishedToClients")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ScheduledTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ScheduledTaskExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ScriptExecutionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ScriptExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AdHocScriptContent")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ScriptExecutionResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("ScriptExecutionResults");
                });
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.SessionRecording", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("RecorderUserId")
                        .HasColumnType("uuid");

                    b.Property<string>("RecorderUserName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.SoftwareInventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.StoredCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.SupportSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AccessCode", "TenantId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.TicketLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.TicketingIntegration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ToolboxItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.WebhookDeliveryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.Alert", b =>
                {
                    b.HasOne("ControlR.Web.Server.Data.Entities.AlertRule", "AlertRule")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.AutomationSuggestion", b =>
                {
                    b.HasOne("ControlR.Web.Server.Data.Entities.SavedScript", "SuggestedScript")
                        .WithMany()
                        .HasForeignKey("SuggestedScriptId")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ClientDeviceAssignment", b =>
                {
                    b.HasOne("ControlR.Web.Server.Data.Entities.AppUser", "ClientUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.Device", b =>
                {
                    ...
                    b.OwnsMany("ControlR.Libraries.Shared.Dtos.Devices.Drive", "Drives", b1 =>
                        {
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.DeviceGroup", b =>
                {
                    b.HasOne("ControlR.Web.Server.Data.Entities.DeviceGroup", "ParentGroup")
                        .WithMany("SubGroups")
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ScheduledTask", b =>
                {
                    b.HasOne("ControlR.Web.Server.Data.Entities.SavedScript", "Script")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.ScheduledTaskExecution", b =>
                {
                    b.HasOne("ControlR.Web.Server.Data.Entities.ScheduledTask", "ScheduledTask")
                        .WithMany()
                        .HasForeignKey("ScheduledTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ControlR.Web.Server.Data.Entities.ScriptExecution", "ScriptExecution")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlR.Web.Server.Data.Entities.WebhookDeliveryLog", b =>
                {
                    ...
                    b.HasOne("ControlR.Web.Server.Data.Entities.WebhookSubscription", "WebhookSubscription")
                        .WithMany()
